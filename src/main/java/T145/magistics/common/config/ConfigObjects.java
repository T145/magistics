...
import T145.magistics.client.renderers.craftingpillars.RingItemRenderer;
...
import T145.magistics.common.blocks.craftingpillars.AnvilPillarBlock;
import T145.magistics.common.blocks.craftingpillars.BrewingPillarBlock;
...
import T145.magistics.common.blocks.craftingpillars.CraftingPillarBlock;
import T145.magistics.common.blocks.craftingpillars.DiskPlayerPillarBlock;
import T145.magistics.common.blocks.craftingpillars.ExtendPillarBlock;
import T145.magistics.common.blocks.craftingpillars.FreezerPillarBlock;
import T145.magistics.common.blocks.craftingpillars.FurnacePillarBlock;
import T145.magistics.common.blocks.craftingpillars.PotPillarBlock;
import T145.magistics.common.blocks.craftingpillars.PumpPillarBlock;
import T145.magistics.common.blocks.craftingpillars.SentryPillarBlock;
import T145.magistics.common.blocks.craftingpillars.ShowOffPillarBlock;
import T145.magistics.common.blocks.craftingpillars.TankPillarBlock;
import T145.magistics.common.blocks.craftingpillars.TrashPillarBlock;
...
import T145.magistics.common.items.baubles.ModEnderPearl;
import T145.magistics.common.items.craftingpillars.BaseItem;
import T145.magistics.common.items.craftingpillars.ItemRingBase;
import T145.magistics.common.items.craftingpillars.ItemVirgacs;
import T145.magistics.common.items.craftingpillars.PillarRecord;
import T145.magistics.common.items.craftingpillars.WinterFood2013;
...
public class ConfigObjects extends CommonProxy {
	...
	public static ItemStack[] present_loot = new ItemStack[] {
		...
		new ItemStack(itemWinterFood2013, 2, 0),
		new ItemStack(itemWinterFood2013, 3, 1),
		new ItemStack(itemWinterFood2013, 4, 2),
		new ItemStack(itemWinterFood2013, 3, 3),
		new ItemStack(itemWinterFood2013, 5, 4),
		new ItemStack(itemWinterFood2013, 4, 5),
		...
		new ItemStack(itemRibbonDiamond, 2, 0),
	...
	public static void loadServer() {
		...
		// Crafting Pillars
		blocks.put(blockBasePillar = (new ExtendPillarBlock(Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setBlockName("extendPillar"), null);
		blocks.put(blockShowOffPillar = (new ShowOffPillarBlock(Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setBlockName("showOffPillar"), null);
		blocks.put(blockCraftingPillar = (new CraftingPillarBlock(Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setBlockName("craftingPillar"), null);
		blocks.put(blockFurnacePillar = (new FurnacePillarBlock(Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setBlockName("furnacePillar"), null);
		blocks.put(blockAnvilPillar = (new AnvilPillarBlock(Material.anvil)).setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setBlockName("anvilPillar"), null);
		blocks.put(blockTankPillar = (new TankPillarBlock(Material.glass)).setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setBlockName("tankPillar"), null);
		blocks.put(blockBrewingPillar = (new BrewingPillarBlock(Material.iron)).setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setBlockName("brewingPillar"), null);
		blocks.put(blockDiskPlayerPillar = (new DiskPlayerPillarBlock(Material.iron)).setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setBlockName("diskPillar"), null);
		blocks.put(blockFreezerPillar = (new FreezerPillarBlock(Material.glass)).setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setBlockName("freezerPillar"), null);
		blocks.put(blockPotPillar = (new PotPillarBlock(Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setBlockName("potPillar"), null);
		blocks.put(blockSentryPillar = (new SentryPillarBlock(Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setBlockName("sentryPillar"), null);
		blocks.put(blockTrashPillar = (new TrashPillarBlock(Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setBlockName("trashPillar"), null);
		blocks.put(blockPumpPillar = (new PumpPillarBlock(Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setBlockName("pumpPillar"), null);

		if (winter) {
			items.add(itemWinterFood2013 = new WinterFood2013(5, 0.5F).setUnlocalizedName("WinterFood"));
			items.add(itemVirgacs = new ItemVirgacs().setUnlocalizedName("Virgacs"));
		...
		items.add(itemRibbonDiamond = new BaseItem().setUnlocalizedName("RibbonDiamond"));

		//itemElysiumLoreBook = new BookElysium().setUnlocalizedName("ElysiumLoreBook");

		items.add(itemRing = new ItemRingBase().setUnlocalizedName("ring_base"));
		items.add(itemRingDummy = new Item().setUnlocalizedName("ring_dummy").setTextureName("craftingpillars:iron_ring"));
	}
	...
	public static void addAchievementsAndCreativeTab() {
		...
		if (winter) {
			achievementPage = new AchievementPage(Magistics.modid,
					achievementGettingStarted, achievementRecursion,
					achievementShowoff, achievementCompressingLiquids,
					achievementRecursion3, achievementChristmas,
					achievementDiamond, achievementDisc);
		} else {
			achievementPage = new AchievementPage(Magistics.modid,
					achievementGettingStarted, achievementRecursion,
					achievementShowoff, achievementCompressingLiquids,
					achievementRecursion3, achievementDisc);
		}
