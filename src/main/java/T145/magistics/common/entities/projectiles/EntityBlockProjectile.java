    ...
    protected void onImpact(MovingObjectPosition movingObjPos)
    {
        if (movingObjPos.entityHit != null)
        {
        	if(this.thrower instanceof EntityPlayer)
        		movingObjPos.entityHit.attackEntityFrom(DamageSource.causePlayerDamage((EntityPlayer) this.thrower), ElysiumStaff.getDamageForBlock(block));
        	else
        		movingObjPos.entityHit.attackEntityFrom(DamageSource.causeMobDamage(this.thrower), ElysiumStaff.getDamageForBlock(block));
