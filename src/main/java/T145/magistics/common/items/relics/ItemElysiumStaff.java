...
public class ItemElysiumStaff extends Item
{
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ)
    {
    	...
    	{
	    	if(ElysiumStaff.getDamageForBlock(world.getBlock(x, y, z)) != 0 && ElysiumStaff.getBlockHolding(stack) == null)
	    	{
	    		Block block = world.getBlock(x, y, z);
	    		ElysiumStaff.setBlockHolding(stack, block);
	    		if(world.isRemote)
    ...
    public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player)
    {
    	...
    	if(meta == 0)
    	{
	    	Block block = ElysiumStaff.getBlockHolding(stack);
	    	...
	    	if(block != null)
			{
				...
				ElysiumStaff.setBlockHolding(stack, null);
			}
    	} else if(meta == 1)
    	{
