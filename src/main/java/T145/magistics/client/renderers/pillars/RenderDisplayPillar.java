		...
		if (workTile.getStackInSlot(0) != null) {
			...
			if (workTile.getStackInSlot(0) != null)
				if (workTile.showNum) {
					...
					resultRenderer.renderFloatingTextWithBackground(0.5F, 1.9F, 0.5F, 0.2F, workTile.getStackInSlot(0).getDisplayName(), Color.WHITE.getRGB(), new Color(0F, 0F, 0F, 0.5F));
