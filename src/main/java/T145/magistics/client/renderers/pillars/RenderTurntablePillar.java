	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		...
		if (workTile.getDisk() != null && !workTile.isEmpty) {
			...
			if (workTile.showNum) {
				...
				glDisable(GL_LIGHTING);
				ExternalRenderer.renderFloatingTextWithBackground(0, 0.6F, 0, 0.4F, workTile.getDisk().getTooltip(FMLClientHandler.instance().getClient().thePlayer, true).get(1).toString(), Color.WHITE.getRGB(), new Color(0F, 0F, 0F, 0.5F));
				glEnable(GL_LIGHTING);
