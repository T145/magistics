...
public class RenderFurnacePillar extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler {
	...
	private ModelRenderer CraftingBottom, CraftingBotSlab, Pillar1, WorkbenchSlab, WorkbenchTop, Pillar2, Pillar3, Pillar4, Icicle1A, Icicle1B, Icicle1C, Icicle2A, Icicle2C, Icicle2B, Icicle3A, Icicle3B, Icicle3C, Icicle3D, Icicle4A, Icicle4B;
