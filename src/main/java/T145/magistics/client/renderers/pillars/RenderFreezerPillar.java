...
public class RenderFreezerPillar extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		...
		if (tank.showNum && !tank.empty) {
			...
			resultRenderer.renderFloatingTextWithBackground(0, 0.35F, 0, 0.3F, tank.getTankInfo(ForgeDirection.UNKNOWN)[0].fluid.getFluid().getName(), Color.WHITE.getRGB(), new Color(0F, 0F, 0F, 0.5F));
			resultRenderer.renderFloatingTextWithBackground(0, 0.2F, 0, 0.2F, tank.getTankInfo(ForgeDirection.UNKNOWN)[0].fluid.amount + " Unit", Color.WHITE.getRGB(), new Color(0F, 0F, 0F, 0.5F));
