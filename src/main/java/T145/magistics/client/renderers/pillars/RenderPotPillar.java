	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		...
		if (pillarTile.getStackInSlot(0) != null) {
			if (pillarTile.showNum) {
				...
				resultRenderer.renderFloatingTextWithBackground(0, 0.9F, 0, 0.2F, pillarTile.getStackInSlot(0).getDisplayName(), Color.WHITE.getRGB(), new Color(0F, 0F, 0F, 0.5F));
