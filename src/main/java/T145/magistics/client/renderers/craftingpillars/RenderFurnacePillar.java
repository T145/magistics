...
public class RenderFurnacePillar extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler
{
	...
	public RenderFurnacePillar()
	{
		if (Magistics.proxy.winter)
			this.TEXTURE_FURNACEPILLAR = new ResourceLocation("craftingpillars:textures/models/furnacePillarFrozen.png");
		else
			this.TEXTURE_FURNACEPILLAR = new ResourceLocation("craftingpillars:textures/models/furnacePillar.png");
