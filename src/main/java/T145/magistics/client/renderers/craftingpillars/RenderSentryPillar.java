...
public class RenderSentryPillar extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler
{
	...
	public RenderSentryPillar()
	{
		if (Magistics.proxy.winter)
			this.TEXTURE_SHOWOFFPILLAR = new ResourceLocation("craftingpillars:textures/models/sentryPillarFrozen.png");
		else
			this.TEXTURE_SHOWOFFPILLAR = new ResourceLocation("craftingpillars:textures/models/sentryPillar.png");
