...
public class BlockSortingChestHungryAlchemicalItemRenderer extends ItemRendererAlchemicalChest {
	...
	private void renderAlchemicalChestOverlay(float x, float y, float z, int meta) {
