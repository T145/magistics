...
public class ParticleWisp extends Particle {
	...
	public void onUpdate() {
		...
		if (target != null) {
			...
			motionX = MathHelper.clamp_float((float) motionX, -0.2F, 0.2F);
			motionY = MathHelper.clamp_float((float) motionY, -0.2F, 0.2F);
			motionZ = MathHelper.clamp_float((float) motionZ, -0.2F, 0.2F);
		} else {
	...
	protected boolean pushOutOfBlocks(double x, double y, double z) {
		...
		if (!worldObj.isAirBlock(new BlockPos(xx, yy, zz)) && worldObj.isBlockNormalCube(new BlockPos(xx, yy, zz), true) && !worldObj.containsAnyLiquid(getEntityBoundingBox())) {
			boolean var16 = !worldObj.isBlockNormalCube(new BlockPos(xx - 1, yy, zz), true);
			boolean var17 = !worldObj.isBlockNormalCube(new BlockPos(xx + 1, yy, zz), true);
			boolean var18 = !worldObj.isBlockNormalCube(new BlockPos(xx, yy - 1, zz), true);
			boolean var19 = !worldObj.isBlockNormalCube(new BlockPos(xx, yy + 1, zz), true);
			boolean var20 = !worldObj.isBlockNormalCube(new BlockPos(xx, yy, zz - 1), true);
			boolean var21 = !worldObj.isBlockNormalCube(new BlockPos(xx, yy, zz + 1), true);
