...
public class TextureHelper {
	...
	public static Map<BlockChestHungryIron.Types, ResourceLocation> ironChestTextures;
	static {
		Builder<BlockChestHungryIron.Types, ResourceLocation> builder = ImmutableMap.<BlockChestHungryIron.Types, ResourceLocation> builder();
		for (BlockChestHungryIron.Types type : BlockChestHungryIron.Types.values())
