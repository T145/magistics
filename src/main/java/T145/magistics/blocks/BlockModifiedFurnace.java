...
public abstract class BlockModifiedFurnace extends BlockContainer {
	...
	private static Block ACTIVE;
	private static Block INACTIVE;
	...
	private BlockModifiedFurnace(boolean isActive) {
		super(Material.rock);
	...
	public BlockModifiedFurnace(boolean isActive, Block instanceActive, Block instanceInactive) {
		this(isActive);

		ACTIVE = instanceActive;
		INACTIVE = instanceInactive;
	}
