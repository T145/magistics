...
public class ContainerInfuser extends Container {
	...
	public ContainerInfuser(InventoryPlayer var1, TileInfuser var2) {
		infuser = var2;
		addSlotToContainer(new Slot(var2, 2, 80, 11));
		addSlotToContainer(new Slot(var2, 3, 28, 102));
		addSlotToContainer(new Slot(var2, 4, 132, 102));
		addSlotToContainer(new Slot(var2, 5, 50, 55));
		addSlotToContainer(new Slot(var2, 6, 110, 55));
		addSlotToContainer(new Slot(var2, 7, 80, 106));
		addSlotToContainer(new SlotOutput(var2, 0, 80, 72));
		addSlotToContainer(new SlotOutput(var2, 1, 80, 135));
		int var3;
